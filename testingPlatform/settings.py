...
SECRET_KEY = 'django-insecure-c-q0p%ox(qht@5(q1@us2ye09u52@d)(2)i(d+!tdz3m9ed*o@'
...
MIDDLEWARE = [
    ...
    'testingPlatform.ngrok_skip_warning.NgrokSkipWarningMiddleware',
]
...
ASGI_APPLICATION = 'testingPlatform.asgi.application'
