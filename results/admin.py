...
class ArchivedStudentAnswerInline(admin.TabularInline):
    ...
    extra = 0
    readonly_fields = ('question_text', 'question_order', 'selected_answers', 'correct_answers', 'is_correct')
...
class ResultAdmin(admin.ModelAdmin):
    list_display = (
        'student', 'test', 'grade', 'correct_answers_count', 'total_questions',
...
class ArchivedResultAdmin(admin.ModelAdmin):
    list_display = (
        'student', 'test', 'grade', 'correct_answers_count',
        'total_questions', 'archived_at', 'archived_by'
    )
    ...
    readonly_fields = (
        'test', 'student', 'archived_by', 'original_result_id', 'grade', 'started_at',
        'completed_at', 'correct_answers_count', 'total_questions', 'device_info',
        'tab_switches_count', 'archived_at',
    )
